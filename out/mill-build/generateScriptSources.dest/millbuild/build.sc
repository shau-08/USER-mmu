...
//MILL_ORIGINAL_FILE_PATH=/home/shauryaps/USER-mmu/build.sc
...
import millbuild.`^`.playground.{builddefs => playground_build}
import millbuild.`^`.playground.dependencies.cde.{build => cde_build}
import millbuild.`^`.playground.dependencies.`berkeley-hardfloat`.{common => hardfloat_common}
import millbuild.`^`.playground.dependencies.`rocket-chip`.{common => rocketchip_common}
import millbuild.`^`.playground.dependencies.diplomacy.{common => diplomacy_common}
